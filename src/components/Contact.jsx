          ...
          <div className="grid md:grid-cols-3 gap-6">
            {contactInfo.map((info) => (
              ...
              >
                ...
                <h3 className="text-lg font-semibold mb-1 group-hover:text-primary transition-colors">{info.title}</h3>
            ...
            <div className="relative">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600 max-w-xl mx-auto">
                  Have a project in mind? Looking for a passionate developer to join your team? 
