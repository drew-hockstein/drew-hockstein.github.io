            ...
            <div className="order-2 md:order-1">
              ...
              <div className="space-y-4 text-gray-700">
                <p className="text-lg leading-relaxed">
                  I'm a full-stack software developer based in Denver,
                  specializing in building scalable tools and intuitive web
                ...
                <p className="text-lg leading-relaxed">
                  ...
                  <span className="text-primary font-medium">SQL</span>, I
                  create robust solutions that solve real-world problems. I'm
