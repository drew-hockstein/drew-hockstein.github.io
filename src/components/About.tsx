...
export default function About(): ReactElement {
  return (
    <section
      id="about"
      className="min-h-screen flex items-center bg-gradient-to-b from-gray-50 to-white pt-20"
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-2 md:order-1">
              <span className="inline-block mb-2 text-sm font-medium text-primary px-3 py-1 bg-primary/10 rounded-full">
                About Me
              </span>
              <h2 id="about-heading" className="text-4xl font-bold mb-6 text-gray-900">
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <p className="text-lg leading-relaxed">
                  ...
                  <span className="text-primary font-medium">SQL</span>, I create robust solutions that solve real-world problems. I'm passionate about clean code, user experience, and continuous learning.
                </p>
              </div>

              <nav className="mt-8 flex items-center space-x-6" aria-label="About links">
                <a
            ...
            <div className="order-1 md:order-2 relative">
              ...
              <div className="absolute top-8 -left-8 w-24 h-24 bg-primary/10 rounded-full -z-10" aria-hidden="true"></div>
              <div className="absolute bottom-8 -right-8 w-40 h-40 bg-secondary/10 rounded-full -z-10" aria-hidden="true"></div>
            </div>
          </div>
        </div>
      </div>
